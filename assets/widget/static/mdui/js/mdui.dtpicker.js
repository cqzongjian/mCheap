...
(function($, document) {
	var domBuffer = '<div class="mdui-dtpicker" data-type="datetime">\
		<div class="mdui-dtpicker-header">\
			<button data-id="btn-cancel" class="mdui-btn">取消</button>\
			<button data-id="btn-ok" class="mdui-btn mdui-btn-blue">确定</button>\
		</div>\
		<div class="mdui-dtpicker-title"><h5 data-id="title-y">年</h5><h5 data-id="title-m">月</h5><h5 data-id="title-d">日</h5><h5 data-id="title-h">时</h5><h5 data-id="title-i">分</h5></div>\
		<div class="mdui-dtpicker-body">\
			<div data-id="picker-y" class="mdui-listpicker">\
				<div class="mdui-listpicker-inner">\
					<ul>\
					</ul>\
				</div>\
			</div>\
			<div data-id="picker-m" class="mdui-listpicker">\
				<div class="mdui-listpicker-inner">\
					<ul>\
					</ul>\
				</div>\
			</div>\
			<div data-id="picker-d" class="mdui-listpicker">\
				<div class="mdui-listpicker-inner">\
					<ul>\
					</ul>\
				</div>\
			</div>\
			<div data-id="picker-h" class="mdui-listpicker">\
				<div class="mdui-listpicker-inner">\
					<ul>\
					</ul>\
				</div>\
			</div>\
			<div data-id="picker-i" class="mdui-listpicker">\
				<div class="mdui-listpicker-inner">\
					<ul>\
					</ul>\
				</div>\
