(function($, window, document) {
	...
	$.Lazyload = $.Class.extend({
		...
		_cacheWidth: function(el) {
			if (el._mdui_lazy_width) {
				return el._mdui_lazy_width;
			}
			return el._mdui_lazy_width = el.offsetWidth;
		},
		_cacheHeight: function(el) {
			if (el._mdui_lazy_height) {
				return el._mdui_lazy_height;
			}
			return el._mdui_lazy_height = el.offsetHeight;
		},
