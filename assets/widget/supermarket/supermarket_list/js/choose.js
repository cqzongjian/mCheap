...
//        for(var i=0;i<len;i++){
//            var m=0,j=0;
//            html+='<div class="mdui-box list-box" data-range="'+data[i].cltpit01011+'" data-lsh="'+data[i].cltpit01id+'" data-star="'+data[i].star+'" data-tiaoshu="'+data[i].tiaoshu+'" data-focus="'+data[i].isfocus+'">';
//            html+='<div class="far">'+data[i].distance+'km</div>';
//            html+='<div class="img-box">';
//            html+='<img src="../image/market_hongxinglu.png" class="market-img-box"/>';
//            html+='</div>';
//            html+='<div class="market-detail">';
//            html+='<div class="market-list-name">'+data[i].cltpit01001+'</div>';
//            html+='<div class="start-box">';
